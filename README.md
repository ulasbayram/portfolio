...
* **Sunucu:** Linux tabanlı Home Server
* **Web Server:** Nginx
...
| :--- | :--- | :--- |
| **LoL "Who Am I?"** | League of Legends karakter tahmin oyunu. | JavaScript, CSS |
...
1. Repoyu klonlayın:
   ```bash
   git clone [https://github.com/ulasbayram/portfolio.git](https://github.com/ulasbayram/portfolio.git)
